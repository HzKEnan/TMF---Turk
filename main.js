...
global.owner = ['994504446044'] // Put your number here
...
global.prefix = new RegExp('^[' + (opts['prefix'] || '‎xzXZ\\/!\\-+£¢€¥^°=¶∆×÷π√✓©®:;?&.') + ']')
    ...
    let _user = global.DATABASE._data.users[m.sender]
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        if (!isPrems && global.DATABASE._data.users[m.sender].limit < m.limit * 1 && plugin.limit) {
          this.reply(m.chat, `Limitiniz doldu, lütfen üzerinden satın alın *${usedPrefix}buy*`, m)
        ...
        try {
          ...
          if (m.limit) m.reply(+ m.limit + ' Kullanılan sınır   ')
        }
  			break
  		}
  	}
...
conn.welcome = 'Merhaba @user @subject Grubuna Hoşgeldin Komutları Görmek İstiyorsan *!yardim* *!kayit* Yazarak Kayit Olabilirsiniz.'
conn.bye = 'Orospu Cocu @user Cıktı!!'
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Bu komut yalnızca _*OWWNER!1!1!*_',
    owner: 'Bu komut yalnızca _*Owner Bot*_!',
    mods: 'Bu komut yalnızca _*Moderator*_ !',
    premium: 'Bu komut sadece üyeler içindir _*Premium*_ !',
    group: 'Bu komut sadece gruplar halinde kullanılabilir!',
    private: 'Bu komut yalnızca Özel Sohbetlerde kullanılabilir!',
    admin: 'Bu komut yalnızca * Yönetici * grubu içindir!',
    botAdmin: 'Bu komutu kullanmak için bot * Admin * yapın!',
    unreg: 'Lütfen bu özelliği kullanmak için yazarak kaydolun:\n\n*!kayit isim.yas*\n\nMisal: *#kayit Kenan.18*'
  }[type]
